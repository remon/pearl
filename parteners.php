...
?>
        ...
        <div class="span2 mg wmiya whiteback _mgt8 lity _5br" >
        	<div class="span2 mg wmiya _mgb5" style="margin-bottom: 15px;">
        		
        	<img src="images/shutter3m.jpg" class="cat_image wmiya">
        	</div>
        
             <p>
                 <ul>
                 <li> Associate Researcher in the LEMNA “Le Laboratoire d’Economie et de Management de
Nantes-Atlantique”, Nantes University, Nantes, France.</li>
<li>Consultant at the CEN “Centre Européen de la Négociation”, Paris, France </li>
<li> Working in collaboration with “Coaches & Catalysts” Peter Knapp, Berlin, Germany </li>
                     </ul>
            </p>
